...
QA Engineer с фокусом на UI и API Testing. Выполняю ручное тестирование, разрабатываю UI- и API-автотесты, оформляю тестовую документацию и анализирую найденные дефекты.
